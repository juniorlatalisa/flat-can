...
public class CodificavelTest {
	...
	public void comparatorInteger() {
		List<Codificavel<Integer>> letras = Arrays.asList(() -> 16, () -> 132, () -> 10, () -> 200);
		letras.sort(Codificavel.COMPARATOR_POR_CODIGO);
		Object[] ordenado = letras.stream().map(l -> l.getCodigo()).toArray();
//		System.out.println(Arrays.toString(ordenado));
	...
	public void comparatorDouble() {
		List<Codificavel<Double>> letras = Arrays.asList(() -> 16.0, () -> 132.0, () -> 10.0, () -> 200.66);
		letras.sort(Codificavel.COMPARATOR_POR_CODIGO);
		Object[] ordenado = letras.stream().map(l -> l.getCodigo()).toArray();
		System.out.println(Arrays.toString(ordenado));
